...
class Phase3_Task1 {
	public static void main(String[] args) {
		...
		*/
		...
		// queries
		String idName = "SELECT nurse_name FROM Nurse WHERE nurse_ID = ?";
		String idSupervisingCnt = "SELECT COUNT(*) FROM Nurse WHERE nurse_supervisor_id = ?";
		String idSupervisingSalaries= "SELECT COALESCE(SUM(nurse_salary), 0) FROM Nurse "
		...
		try {
			...
			System.out.print("Enter nurse_ID: ");			
